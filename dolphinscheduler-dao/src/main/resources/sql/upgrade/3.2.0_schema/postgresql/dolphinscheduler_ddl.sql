...
CREATE TABLE if not exists "t_ds_data_preview_view" (
    "id" int NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "unique_data_preview_view_scope_name" ON "t_ds_data_preview_view"
    ("user_id", "datasource_id", "database_name", "schema_name", "table_name", "view_name");
CREATE INDEX IF NOT EXISTS "idx_data_preview_view_scope" ON "t_ds_data_preview_view"
