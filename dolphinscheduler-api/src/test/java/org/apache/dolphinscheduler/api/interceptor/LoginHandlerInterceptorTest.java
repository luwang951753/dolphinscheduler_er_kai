...
public class LoginHandlerInterceptorTest {
    ...
    @Test
    public void testPreHandleSkipUiResource() {
        HttpServletRequest request = Mockito.mock(HttpServletRequest.class);
        HttpServletResponse response = Mockito.mock(HttpServletResponse.class);

        when(request.getRequestURI()).thenReturn("/dolphinscheduler/ui/");
        when(request.getContextPath()).thenReturn("/dolphinscheduler/");

        Assertions.assertTrue(interceptor.preHandle(request, response, null));
    }

    @Test
    public void testPreHandleSkipUiAsset() {
        HttpServletRequest request = Mockito.mock(HttpServletRequest.class);
        HttpServletResponse response = Mockito.mock(HttpServletResponse.class);

        when(request.getRequestURI()).thenReturn("/dolphinscheduler/ui/assets/index.js");
        when(request.getContextPath()).thenReturn("/dolphinscheduler");
    ...
    @Test
    public void testPreHandleSkipUiResourceWhenContextPathIsEmpty() {
        HttpServletRequest request = Mockito.mock(HttpServletRequest.class);
        HttpServletResponse response = Mockito.mock(HttpServletResponse.class);
    ...
    @Test
    public void testPreHandleDoesNotSkipApiRequest() {
        HttpServletRequest request = Mockito.mock(HttpServletRequest.class);
        HttpServletResponse response = Mockito.mock(HttpServletResponse.class);

        when(request.getRequestURI()).thenReturn("/dolphinscheduler/projects/list");
        when(request.getContextPath()).thenReturn("/dolphinscheduler");
