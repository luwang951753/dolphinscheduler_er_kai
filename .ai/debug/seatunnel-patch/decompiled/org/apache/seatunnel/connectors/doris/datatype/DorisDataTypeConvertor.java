...
public class DorisDataTypeConvertor
implements DataTypeConvertor<String> {
    ...
    public SeaTunnelDataType<?> toSeaTunnelType(String connectorDataType) {
        ...
        return this.toSeaTunnelType(connectorDataType, dataTypeProperties);
    }
    ...
    public SeaTunnelDataType<?> toSeaTunnelType(String connectorDataType, Map<String, Object> dataTypeProperties) throws DataTypeConvertException {
        Preconditions.checkNotNull(connectorDataType, "mysqlType can not be null");
        switch (connectorDataType.toUpperCase(Locale.ROOT)) {
            case "NULL": {
        ...
        throw new UnsupportedOperationException(String.format("Doesn't support DORIS type '%s''  yet.", connectorDataType));
    }
    ...
    public String toConnectorType(SeaTunnelDataType<?> seaTunnelDataType, Map<String, Object> dataTypeProperties) throws DataTypeConvertException {
        ...
        throw new UnsupportedOperationException(String.format("Doesn't support Doris type '%s''  yet.", new Object[]{sqlType}));
    }
