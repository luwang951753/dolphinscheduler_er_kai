...
import org.apache.dolphinscheduler.api.service.DataPreviewQueryService;
import org.apache.dolphinscheduler.api.service.DataPreviewViewService;
...
public class DataSourceController extends BaseController {
    ...
    @Autowired
    private DataPreviewQueryService dataPreviewQueryService;
    ...
    @Operation(summary = "tableColumnMetas", description = "GET_DATASOURCE_TABLE_COLUMNS_NOTES")
    @Parameters({
            @Parameter(name = "datasourceId", description = "DATA_SOURCE_ID", required = true, schema = @Schema(implementation = int.class, example = "1")),
            @Parameter(name = "tableName", description = "TABLE_NAME", required = true, schema = @Schema(implementation = String.class, example = "test")),
            @Parameter(name = "database", description = "DATABASE", required = true, schema = @Schema(implementation = String.class, example = "test"))
    ...
    @Operation(summary = "previewTableStructure", description = "DATA_PREVIEW_TABLE_STRUCTURE_NOTES")
    @GetMapping(value = "/preview-table-structure")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(DATA_PREVIEW_QUERY_ERROR)
    ...
    @Operation(summary = "previewSql", description = "DATA_PREVIEW_SQL_QUERY_NOTES")
    ...
    @Operation(summary = "previewSqlExplain", description = "DATA_PREVIEW_SQL_EXPLAIN_NOTES")
    @PostMapping(value = "/preview-sql-explain")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(DATA_PREVIEW_QUERY_ERROR)
    ...
    @Operation(summary = "queryDataPreviewViews", description = "DATA_PREVIEW_VIEW_QUERY_NOTES")
    @GetMapping(value = "/preview-views")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(DATA_PREVIEW_QUERY_ERROR)
    ...
    @Operation(summary = "createDataPreviewView", description = "DATA_PREVIEW_VIEW_CREATE_NOTES")
    @PostMapping(value = "/preview-views")
    @ResponseStatus(HttpStatus.CREATED)
    @ApiException(DATA_PREVIEW_QUERY_ERROR)
    ...
    @Operation(summary = "updateDataPreviewView", description = "DATA_PREVIEW_VIEW_UPDATE_NOTES")
    @PutMapping(value = "/preview-views/{id}")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(DATA_PREVIEW_QUERY_ERROR)
    ...
    @Operation(summary = "deleteDataPreviewView", description = "DATA_PREVIEW_VIEW_DELETE_NOTES")
    @DeleteMapping(value = "/preview-views/{id}")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(DATA_PREVIEW_QUERY_ERROR)
    ...
    @Operation(summary = "createTargetTable", description = "CREATE_DATA_SOURCE_NOTES")
    @PostMapping(value = "/preview-target-table")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(CONNECT_DATASOURCE_FAILURE)
    ...
    @Operation(summary = "createTargetTable", description = "CREATE_DATA_SOURCE_NOTES")
    @PostMapping(value = "/create-target-table")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(CONNECT_DATASOURCE_FAILURE)
