...
public enum Status {
    ...
    DATA_PREVIEW_VIEW_NAME_EXISTS(1200037, "data preview view name already exists", "数据预览视图名称已存在"),
    DATA_PREVIEW_VIEW_NAME_INVALID(1200038, "data preview view name is invalid", "数据预览视图名称无效"),
    DATA_PREVIEW_VIEW_CONFIG_INVALID(1200039, "data preview view config is invalid", "数据预览视图配置无效"),
