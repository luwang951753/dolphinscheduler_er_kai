...
public interface DataFlowSyncStatService {

    List<StatResponse> queryStats(User loginUser, QueryRequest request);

    StatResponse upsertStat(User loginUser, UpsertRequest request);
}
