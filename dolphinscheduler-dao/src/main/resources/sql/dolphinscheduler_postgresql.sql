...
--
-- Table structure for table t_ds_data_preview_view
--

DROP TABLE IF EXISTS t_ds_data_preview_view;
CREATE TABLE t_ds_data_preview_view (
    id int NOT NULL,
    user_id int NOT NULL,
...
CREATE UNIQUE INDEX unique_data_preview_view_scope_name on t_ds_data_preview_view
    (user_id, datasource_id, database_name, schema_name, table_name, view_name);
CREATE INDEX idx_data_preview_view_scope on t_ds_data_preview_view
    (user_id, datasource_id, database_name, schema_name, table_name);
...
DROP SEQUENCE IF EXISTS t_ds_data_preview_view_id_sequence;
CREATE SEQUENCE t_ds_data_preview_view_id_sequence;
ALTER TABLE t_ds_data_preview_view ALTER COLUMN id SET DEFAULT NEXTVAL('t_ds_data_preview_view_id_sequence');
